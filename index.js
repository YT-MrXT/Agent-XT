...
async function sendWelcome(member) {
  ...
  const titulo = (config.welcome_title || '👋 Bem-vindo(a)!')
...
app.post('/api/:guildId/welcome-config', requireGuildAdminApi, (req, res) => {
  const { guildId } = req.params;
  const { welcome_channel, welcome_title, welcome_msg, welcome_embed, welcome_image, autorole } = req.body;
  ...
  `).run(guildId, welcome_channel||null, welcome_title||null, welcome_msg||'Bem-vindo {user}!', welcome_embed==='1'?1:0, welcome_image||null, autorole||null);
...
app.post('/api/:guildId/embeds/editar', requireGuildAdminApi, (req, res) => {
  const { guildId } = req.params;
  const { id, titulo, descricao, cor, imagem, thumbnail, footer, mensagem } = req.body;
...
const dashboardJS = `
  ...
  function abrirEditarEmbed(e) {
    ...
    document.getElementById('editar-embed-cor').value = e.color || '';
...
A nossa equipa irá responder o mais brevemente possível!</textarea>
    ...
    <div id="embeds_tab" class="section" style="display:none">
              ...
              <tbody>
                ${savedEmbeds.map(e => {
                  ...
                  <tr>
                    ...
                    <td>
                      <button type="button" class="btn btn-primary" style="padding:4px 10px;font-size:0.8rem" onclick='abrirEditarEmbed(${JSON.stringify({ id: e.id, name: e.name, ...embedData })})' title="Editar esta embed">✏️</button>
      ...
      <!-- Modal de edição de embed guardada -->
      <div id="editar-embed-modal" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.6);z-index:1000;align-items:center;justify-content:center">
        <div class="card" style="max-width:560px;width:92%;max-height:86vh;overflow:auto">
          <h2 style="margin-top:0">✏️ Editar Embed: <span id="editar-embed-nome"></span></h2>
          <input type="hidden" id="editar-embed-id">
          <div class="grid-2">
            <div class="form-group">
              <label>Cor (hex)</label>
              <input type="text" id="editar-embed-cor" placeholder="#5865F2">
            </div>
          </div>
          <div class="form-group">
            <label>Título</label>
            <input type="text" id="editar-embed-titulo" maxlength="256">
          </div>
          <div class="form-group">
            <label>Descrição</label>
            <textarea id="editar-embed-descricao" rows="4"></textarea>
          </div>
          <div class="grid-2">
            <div class="form-group">
              <label>URL da Imagem (opcional)</label>
              <input type="text" id="editar-embed-imagem" placeholder="https://...">
            </div>
            <div class="form-group">
              <label>URL da Thumbnail (opcional)</label>
              <input type="text" id="editar-embed-thumbnail" placeholder="https://...">
            </div>
          </div>
          <div class="form-group">
            <label>Rodapé (opcional)</label>
            <input type="text" id="editar-embed-footer" placeholder="Texto do rodapé">
          </div>
          <div class="form-group">
            <label>Mensagem fora do embed (opcional)</label>
            <input type="text" id="editar-embed-mensagem" placeholder="Ex: @everyone">
          </div>
          <div class="grid-2">
    ...
    <div id="welcome" class="section" style="display:none">
      ...
      <div class="card">
        <form id="form-welcome">
          ...
          <div class="form-group">
            <label>Título da Embed de Boas-vindas ({user}, {server}, {count})</label>
            <input type="text" name="welcome_title" value="${(guildConfig?.welcome_title || '👋 Bem-vindo(a)!').replace(/"/g,'&quot;')}" placeholder="Ex: 👋 Bem-vindo(a) {user}!">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label>Imagem/Banner da Embed (URL, opcional)</label>
