...
A nossa equipa irá responder o mais brevemente possível!</textarea>
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-top:10px">
            ...
            <div>
              ...
              <div class="form-group">
                ...
                <select name="welcome_image_pos" id="welcome_image_pos">
                  <option value="bottom" selected>Imagem grande em baixo</option>
                  <option value="thumbnail">Imagem pequena à direita</option>
                  <option value="none">Sem imagem</option>
                </select>
              </div>
              <div class="form-group">
  ...
  <script>
    ...
    function limparFormWelcome() {
      ...
      document.getElementById('welcome_image_pos').value = 'bottom';
      ...
      if (id) {
        ...
        try {
          ...
          if (w && w.id) {
            ...
            document.getElementById('welcome_image_pos').value = w.welcome_image_pos || 'bottom';
