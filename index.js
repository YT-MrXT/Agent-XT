...
<body>
  ...
  function renderDashboard(user, selectedGuild, error = null) {
    ...
    const inviteUrl = `https://discord.com/api/oauth2/authorize?client_id=${CONFIG.CLIENT_ID}&permissions=8&scope=bot%20applications.commands&redirect_uri=${encodeURIComponent(CONFIG.REDIRECT_URI.replace('/auth/callback', '/dashboard'))}&response_type=code`;
    return `<!DOCTYPE html>
<html lang="pt">
<head>
  <link rel="icon" type="image/png" href="${CONFIG.BOT_AVATAR_URL}">
