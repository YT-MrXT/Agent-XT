...
2. MEDIUM — calão vulgar/sexual EXPLÍCITO (palavrões reais, não insultos leves): "pila", "caralho", "foda-se", "cabrão", "puta", "merda", termos sexuais explícitos, e variações disfarçadas destes. Aplica-se mesmo que a palavra apareça sozinha ou sem intenção agressiva clara. Nunca dês benefício da dúvida a um significado alternativo inofensivo (ex.: "pila" como gíria antiga para dinheiro) — assume o sentido vulgar.
...
- "foda" usada como elogio/gíria positiva ("sou foda", "isto é foda", "ele é muito foda") → NÃO é violação (violacao: false). Só conta como MEDIUM quando usada no sentido sexual explícito ou em "foda-se", "vai-te foder", "que foda" no sentido negativo/de frustração agressiva.
- "fuck"/"shit" (e variações) usadas como interjeição de frustração pontual, reação a algo que correu mal, SEM estar dirigida como insulto a uma pessoa (ex.: "fuck, esqueci-me da chave", "deu erro outra vez, fuck", "ah shit") → severidade LOW, não MEDIUM. Só sobe a MEDIUM/HIGH se for usada para insultar alguém diretamente (ex.: "fuck you", "seu fucking idiota") ou em contexto sexual explícito.
- Aplica este mesmo raciocínio a outras palavras que tenham um uso comum como elogio/gíria positiva ou interjeição de frustração não-dirigida, mesmo que a mesma palavra também tenha um sentido vulgar — não bloqueies o uso não-agressivo.
...
- "foda-se" / "vai-te foder" → violacao: true, categoria: "palavrao", severidade: "MEDIUM"
- "fuck, esqueci-me da chave" / "ah shit" (frustração, não dirigida a ninguém) → violacao: true, categoria: "palavrao", severidade: "LOW"
- "fuck you" / "seu fucking idiota" (dirigido a alguém como insulto) → violacao: true, categoria: "insulto", severidade: "MEDIUM"
