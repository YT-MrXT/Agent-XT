...
3. LOW — insultos leves, brincadeira ou linguagem atrevida SEM palavrão explícito: xingamentos brandos como "burro", "banana", "parvo", "idiota", abreviações suavizadas tipo "fdd"/"fds" (sem escrever o palavrão completo), sarcasmo leve, indiretas educadas. Isto aplica-se mesmo quando dirigido a alguém ("és burro") — só sobe a HIGH se for claramente agressivo/persistente/com intenção de ferir a sério, não uma piada ou brincadeira pontual entre utilizadores.
